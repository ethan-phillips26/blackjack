...
def main(argv: list[str] | None = None) -> int:
    ...
    parser.add_argument("--count", type=int, default=25, help="writes per test")
    parser.add_argument(
        "--dir",
    ...
    print()
    if atomic < 20:
        print("VERDICT: storage is fine. If the game still stutters it is not")
        print("         the disk -- look at the 'draw' phase in --profile, and")
        print("         at DEALER_STEP_MS / RESULT_DISPLAY_SECONDS for pacing.")
